...
def process_db(db, train_path, valid_path, valid_prob=0.1):
    ...
    # load the database
    data = np.load(db, allow_pickle=True)['clips']
    all_windows_train = []
    all_windows_valid = []
...
if __name__ == '__main__':
    data_path = 'C:/Users/VML/Desktop/2022_Spring/Motion_Graphics/Final_project/downloadCode/output_data/'
    train_path = 'C:/Users/VML/Desktop/2022_Spring/Motion_Graphics/Final_project/downloadCode/train_data/'
    valid_path = 'C:/Users/VML/Desktop/2022_Spring/Motion_Graphics/Final_project/downloadCode/valid_data/'
